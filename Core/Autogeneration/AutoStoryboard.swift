...
enum StoryboardScene {
  ...
  enum Feedback: StoryboardSceneType {
    static let storyboardName = "FeedbackViewController"

    static func initialViewController() -> FeedbackViewController {
      guard let vc = storyboard().instantiateInitialViewController() as? FeedbackViewController else {
        fatalError("Failed to instantiate initialViewController for \(self.storyboardName)")
      }
      return vc
    }
  ...
  enum NewsDescription: StoryboardSceneType {
    static let storyboardName = "NewsDescriptionViewController"

    static func initialViewController() -> NewsDescriptionViewController {
      guard let vc = storyboard().instantiateInitialViewController() as? NewsDescriptionViewController else {
        fatalError("Failed to instantiate initialViewController for \(self.storyboardName)")
      }
      return vc
    }
  ...
  enum Skins: StoryboardSceneType {
    static let storyboardName = "SkinsViewController"

    static func initialViewController() -> SkinsViewController {
      guard let vc = storyboard().instantiateInitialViewController() as? SkinsViewController else {
        fatalError("Failed to instantiate initialViewController for \(self.storyboardName)")
      }
      return vc
    }
